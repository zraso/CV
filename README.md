...
|--|--|--|--|--|
| **Travelist** [Heroku site](https://travelistmakers.herokuapp.com/) [Github](https://github.com/melvinlau/travelist) | A smart travel packing list assistant that uses weather data and custom user input to create a handy packing list for any trip | 2 weeks | Node.js, Express, React, MongoDB, Materials UI | Travis, Cypress, Jest  |
